...
///
/// Dữ liệu thực từ Firebase qua ShipperRepository.watchActiveShippers()
...
class _AdminMapMonitorScreenState extends State<AdminMapMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ShipperModel>>(
                  ...
                  child: Stack(
                    children: [
                      ...
                      ...activeShippers.asMap().entries.map((entry) {
                        ...
                        final isSelected = _selected?.uid == s.uid;
                        return Positioned(
                          left: dx,
                          top: dy,
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(
                                  // Hiển thị tọa độ thực từ Firestore nếu có, ngược lại hiển thị 'Chưa cập nhật'
                                  "Mã: ${s.shipperId} • SĐT: ${s.phone}"
                                  "${s.currentLat != null ? ' • GPS: ${s.currentLat!.toStringAsFixed(4)}, ${s.currentLng!.toStringAsFixed(4)}' : ' • Vị trí: Chưa cập nhật'}"),
                              trailing: Container(
                                padding: const EdgeInsets.symmetric(
